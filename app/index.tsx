...
const data = [
  ...
  },
  {
    id: "2",
    name: "SQL#",
    desc: "Язык SQL со мной с 2008 года, я впервые познакомилс с ним в институте, диалект T-SQL. " +
  ...
  },
  {
    ...
    desc: "Учил в институте, то что учил к современному C++ имеет мало отношения. " +
      "По работе практически не использую, изредка использую C для программирования " + 
